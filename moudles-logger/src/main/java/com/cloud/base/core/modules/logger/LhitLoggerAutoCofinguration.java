package com.cloud.base.core.modules.logger;
...
import com.cloud.base.core.modules.logger.adapter.impl.DefaultLhitLoggerStorageAdapter;
import com.cloud.base.core.modules.logger.adapter.impl.DefaultRoleInfoByUserAdapter;
import com.cloud.base.core.modules.logger.adapter.impl.DefaultUserInfoFromRequest;
import com.cloud.base.core.modules.logger.aop.LhitLoggerMethodAop;
...
public class LhitLoggerAutoCofinguration {
    ...
    public AspectJExpressionPointcutAdvisor permsPointcutAdvisor() {
        ...
        advisor.setExpression("@annotation(com.cloud.base.core.modules.logger.annotation.LhitLogger)");
