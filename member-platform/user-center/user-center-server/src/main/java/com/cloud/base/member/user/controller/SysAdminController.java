...
// ///////////////////////////////////用户操作
    ...
    public ServerResponse createUser(@Validated @RequestBody SysUserCreateParam param, @RequestHeader(value = "LHTOKEN", defaultValue = "") String token) throws Exception {
        log.info("|-----------------------------------------------|");
        log.info("进入 创建用户 接口 : SysUserController-createUser ");
        sysAdminService.createUser(param, getCurrentSysUser(token));
    ...
    public ServerResponse updateUser(@Validated @RequestBody SysUserUpdateParam param, @RequestHeader(value = "LHTOKEN", defaultValue = "") String token) throws Exception {
        log.info("|-----------------------------------------------|");
        log.info("进入 修改用户 接口 : SysUserController-updateUser ");
        sysAdminService.updateUser(param, getCurrentSysUser(token));
    ...
    public ServerResponse<PageInfo<SysUser>> queryUser(@Validated @RequestBody SysUserQueryParam param, @RequestHeader(value = "LHTOKEN", defaultValue = "") String token) throws Exception {
        log.info("|-----------------------------------------------|");
        log.info("进入 查询用户 接口 : SysUserController-queryUser ");
        PageInfo<SysUser> pageInfo = sysAdminService.queryUser(param, getCurrentSysUser(token));
    ...
    public ServerResponse setUserRoleList(@Validated @RequestBody SysUserRoleSetParam param, @RequestHeader(value = "LHTOKEN", defaultValue = "") String token) throws Exception {
        log.info("|-----------------------------------------------|");
        log.info("进入 设置用户角色列表 接口 : SysUserController-setUserRegions");
        sysAdminService.setUserRoleList(param, getCurrentSysUser(token));
    ...
    public ServerResponse delUser(@PathVariable(value = "userId") Long userId, @RequestHeader(value = "LHTOKEN", defaultValue = "") String token) throws Exception{
        log.info("|-----------------------------------------------|");
        log.info("进入 删除用户 接口 : SysUserController-delUser");
        sysAdminService.delUser(userId, getCurrentSysUser(token));
...
// ///////////////////////////////////资源管理
    ...
    public ServerResponse createRes(@Validated @RequestBody SysResCreateParam param, @RequestHeader(value = "LHTOKEN", defaultValue = "") String token) throws Exception {
        log.info("|-----------------------------------------------|");
        log.info("进入 创建权限 接口 : SysAdminController-createRes ");
        sysAdminService.createRes(param, getCurrentSysUser(token));
        return ServerResponse.createBySuccess("创建成功");
    }
    ...
    public ServerResponse deleteRes(@PathVariable(value = "resId") Long resId, @RequestHeader(value = "LHTOKEN", defaultValue = "") String token) throws Exception {
        log.info("|-----------------------------------------------|");
        log.info("进入 删除权限信息 接口 : SysAdminController-deleteRes ");
        sysAdminService.deleteRes(resId, getCurrentSysUser(token));
        return ServerResponse.createBySuccess("删除成功");
    }
...
// ///////////////////////////////////角色管理
    ...
    public ServerResponse createRole(@Validated @RequestBody SysRoleCreateParam param, @RequestHeader(value = "LHTOKEN", defaultValue = "") String token) throws Exception {
        log.info("|-----------------------------------------------|");
        log.info("进入 创建系统角色信息 接口 : SysAdminController-createRole ");
        sysAdminService.createRole(param, getCurrentSysUser(token));
        return ServerResponse.createBySuccess("创建成功");
    }
    ...
    public ServerResponse updateRole(@Validated @RequestBody SysRoleUpdateParam param, @RequestHeader(value = "LHTOKEN", defaultValue = "") String token) throws Exception {
        log.info("|-----------------------------------------------|");
        log.info("进入 修改系统角色信息 接口 : SysAdminController-updateRole ");
        sysAdminService.updateRole(param, getCurrentSysUser(token));
        return ServerResponse.createBySuccess("创建成功");
    }
    ...
    public ServerResponse deleteRole(@PathVariable(name = "roleId") Long roleId, @RequestHeader(value = "LHTOKEN", defaultValue = "") String token) throws Exception {
        log.info("|-----------------------------------------------|");
        log.info("进入 删除系统角色信息 接口 : SysAdminController-deleteRole ");
        sysAdminService.deleteRole(roleId, getCurrentSysUser(token));
        return ServerResponse.createBySuccess("删除成功");
    }
    ...
    public ServerResponse<PageInfo<SysRole>> queryRole(@Validated @RequestBody SysRoleQueryParam param, @RequestHeader(value = "LHTOKEN", defaultValue = "") String token) throws Exception {
        log.info("|-----------------------------------------------|");
        log.info("进入 查询系统角色信息 接口 : SysAdminController-queryRole ");
        PageInfo<SysRole> pageInfo = sysAdminService.queryRole(param, getCurrentSysUser(token));
        return ServerResponse.createBySuccess("查询成功", pageInfo);
    }
    ...
    public ServerResponse saveRoleRes(@Validated @RequestBody SysRoleResSaveParam param, @RequestHeader(value = "LHTOKEN", defaultValue = "") String token) throws Exception {
        log.info("|-----------------------------------------------|");
        log.info("进入 保存角色资源（权限） 接口 : SysAdminController-queryRole ");
        sysAdminService.saveRoleRes(param, getCurrentSysUser(token));
    ...
    public ServerResponse<List<SysRes>> getSysResListByRoleId(@PathVariable(name = "roleId") Long roleId, @RequestHeader(value = "LHTOKEN", defaultValue = "") String token) throws Exception {
        log.info("|-----------------------------------------------|");
        log.info("进入 查询角色资源列表 接口 : SysAdminController-getSysResListByRoleId ");
        List<SysRes> sysResList = sysAdminService.getSysResListByRoleId(roleId, getCurrentSysUser(token));
