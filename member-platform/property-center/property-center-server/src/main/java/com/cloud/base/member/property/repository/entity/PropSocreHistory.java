...
@Setter
@Getter
@Table(name="prop_socre_history")
public class PropSocreHistory implements Serializable {
     ...
     * 动账积分类型 1-积分 2-冻结解放
     */
    @ApiModelProperty(value="动账积分类型 1-积分 2-冻结解放")
