package com.cloud.base.modules.logger;
...
import com.cloud.base.modules.logger.adapter.impl.DefaultLhitLoggerStorageAdapter;
import com.cloud.base.modules.logger.adapter.impl.DefaultRoleInfoByUserAdapter;
import com.cloud.base.modules.logger.adapter.impl.DefaultUserInfoFromRequest;
import com.cloud.base.modules.logger.aop.LhitLoggerMethodAop;
import com.cloud.base.modules.logger.properties.LhitLoggerProperties;
...
public class LhitLoggerAutoCofinguration {
    ...
    public AspectJExpressionPointcutAdvisor permsPointcutAdvisor() {
        ...
        advisor.setExpression("@annotation(com.cloud.base.modules.logger.annotation.LhitLogger)");
