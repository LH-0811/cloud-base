...
public class TokenToAuthorityAop implements Ordered {
    ...
    @Pointcut("@within(com.cloud.base.modules.xugou.client.component.annotation.TokenToAuthority) || @annotation(com.cloud.base.modules.xugou.client.component.annotation.TokenToAuthority)")
