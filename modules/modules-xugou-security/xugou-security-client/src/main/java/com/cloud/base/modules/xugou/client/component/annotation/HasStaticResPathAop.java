...
public class HasStaticResPathAop {
    ...
    @Pointcut("@within(com.cloud.base.modules.xugou.client.component.annotation.HasStaticResPath) || @annotation(com.cloud.base.modules.xugou.client.component.annotation.HasStaticResPath)")
