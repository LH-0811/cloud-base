...
public class HasPermsCodeAop {
    ...
    @Pointcut("@within(com.cloud.base.modules.xugou.client.component.annotation.HasPermsCode) || @annotation(com.cloud.base.modules.xugou.client.component.annotation.HasPermsCode)")
