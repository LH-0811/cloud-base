...
public class HasPermsCodeAop {
    ...
    @Pointcut("@within(com.cloud.base.modules.security.client.component.annotation.HasPermsCode) || @annotation(com.cloud.base.modules.security.client.component.annotation.HasPermsCode)")
