...
public class TokenToAuthorityAop implements Ordered {
    ...
    @Pointcut("@within(com.cloud.base.modules.security.client.component.annotation.TokenToAuthority) || @annotation(com.cloud.base.modules.security.client.component.annotation.TokenToAuthority)")
