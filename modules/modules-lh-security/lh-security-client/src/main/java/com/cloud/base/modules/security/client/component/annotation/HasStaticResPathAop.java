...
public class HasStaticResPathAop {
    ...
    @Pointcut("@within(com.cloud.base.modules.security.client.component.annotation.HasStaticResPath) || @annotation(com.cloud.base.modules.security.client.component.annotation.HasStaticResPath)")
