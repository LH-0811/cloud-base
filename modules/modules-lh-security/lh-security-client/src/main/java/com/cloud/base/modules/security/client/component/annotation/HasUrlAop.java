...
public class HasUrlAop {
    ...
    @Pointcut("@within(com.cloud.base.modules.security.client.component.annotation.HasUrl) || @annotation(com.cloud.base.modules.security.client.component.annotation.HasUrl)")
