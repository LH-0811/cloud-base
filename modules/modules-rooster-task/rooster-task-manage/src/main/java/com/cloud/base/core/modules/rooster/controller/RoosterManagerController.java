...
public class RoosterManagerController {
    ...
    public ServerResponse registerWorker(@Valid @RequestBody RoosterTaskCreateParam param, HttpServletRequest request) throws Exception {
        ...
        roosterTaskService.registerWorker(param,request.getLocalAddr(),request.getLocalPort());
