package com.cloud.base.common.youji.cronjob.worker.controller;
...
@RestController
public class Youji2WorkerTaskReceiveController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "path", dataType = "Youji2WorkerReceiveTaskParam", dataTypeClass = Youji2WorkerReceiveTaskParam.class, name = "param", value = "参数")
    })
    public ServerResponse receiveWorker(@Valid @RequestBody Youji2WorkerReceiveTaskParam param) throws Exception {
